...
namespace Collision
{
	...
	bool PixelPerfectTestModel(Model& model1, Model& model2, sf::Uint8 AlphaLimit) {
		sf::Sprite &Object1 = *model1.sprite;
		sf::Sprite &Object2 = *model2.sprite;
		sf::FloatRect Intersection;
		if (Object1.getGlobalBounds().intersects(Object2.getGlobalBounds(), Intersection)) {
			sf::IntRect O1SubRect = model1.textureRectOriginal;
			sf::IntRect O2SubRect = model2.textureRectOriginal;
